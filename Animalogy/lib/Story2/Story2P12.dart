...
class _Story2P12State extends State<Story2P12> {
  ...
  Future<void> storePageData() async {
    ...
    await prefs.setString('currentPage', 'story2P12');
  ...
  Future<void> play() async {
    await player.setAsset('assets/audio/21.m4a');
    player.play();
    setState(() {
      playing = true;
    });
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        backgroundColor: const Color(0xFFeec276),
        body:Column(
          ...
          children: [
            Flexible(
              child: Stack(children: <Widget>[
                const Center(
                  child: Image(
                      image: AssetImage('assets/Backgrounds/21.png'),
