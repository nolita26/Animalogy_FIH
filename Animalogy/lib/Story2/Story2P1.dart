...
class _Story2P1State extends State<Story2P1> {
  ...
  Future<void> storePageData() async {
    ...
    await prefs.setString('currentPage', 'story2P1');
    final String? action = prefs.getString('currentPage');
    print(action);
  }

  Future<void> play() async {
    await player.setAsset('assets/audio/(10).m4a');
    player.play();
    setState(() {
      playing = true;
    });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(0xFFd0b68d),
      body:Column(
        ...
        children: [
          Flexible(
            child: Stack(children: <Widget>[
              const Center(
                child: Image(
                    image: AssetImage('assets/Backgrounds/10.png'),
