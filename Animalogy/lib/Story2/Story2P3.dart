...
class _Story2P3State extends State<Story2P3> {
  ...
  Future<void> storePageData() async {
    ...
    await prefs.setString('currentPage', 'story2P3');
  ...
  Future<void> play() async {
    await player.setAsset('assets/audio/12.wav');
    player.play();
    setState(() {
      playing = true;
    });
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        backgroundColor: const Color(0xFF9aa885),
        body:Column(
          ...
          children: [
            Flexible(
              child: Stack(children: <Widget>[
                const Center(
                  child: Image(
                      image: AssetImage('assets/Backgrounds/12.png'),
                    ...
                    Align(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          ...
                          pause();
                          Navigator.push(context, MaterialPageRoute(builder: (context) => const Story2P2()));
                        },
                      ),
                    ),
                    Align(
