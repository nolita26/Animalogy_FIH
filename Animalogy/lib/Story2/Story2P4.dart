...
class _Story2P4State extends State<Story2P4> {
  ...
  Future<void> play() async {
    await player.setAsset('assets/audio/13.wav');
    player.play();
    setState(() {
      playing = true;
    });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(0xFFd1bd5e),
      body:Column(
                  ...
                  Align(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        ...
                        pause();
                        Navigator.push(context, MaterialPageRoute(builder: (context) => const Story2P5()));
                      },
                    ),
                  ),
                ],
