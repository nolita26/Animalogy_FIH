...
class Story2P15 extends StatefulWidget {
  const Story2P15({Key? key}) : super(key: key);

  @override
  State<Story2P15> createState() => _Story2P15State();
}

class _Story2P15State extends State<Story2P15> with TickerProviderStateMixin {
  ...
  Future<void> storePageData() async {
    ...
    await prefs.setString('currentPage', 'story2P15');
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        backgroundColor: const Color(0xFFca8c42),
        body: Column(
                    ...
                    Align(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          ...
                          pause();
                          Navigator.push(context, MaterialPageRoute(builder: (context) => const Story2P14()));
                        },
                      ),
                    ),
                    Align(
