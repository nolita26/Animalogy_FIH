...
class QuizAnsW3 extends StatefulWidget {
  const QuizAnsW3({Key? key}) : super(key: key);

  @override
  State<QuizAnsW3> createState() => _QuizAnsW3State();
}

class _QuizAnsW3State extends State<QuizAnsW3> {
  ...
  Future<void> storePageData() async {
    ...
    await prefs.setString('currentPage', 'quizAnsW3');
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: GestureDetector(
            onTap: () {
              Navigator.pop(context, MaterialPageRoute(builder: (context) => const StoryP5()));
            },
            child: Center(
                child: Column(
